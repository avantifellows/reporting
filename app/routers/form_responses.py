    ...
    def router(self):
        ...
        def get_form_responses(
            ...
            try:
                ...
                form_responses = self.__form_responses_db.get_form_responses(session_id, user_id)
                
                if not form_responses:
                    raise HTTPException(status_code=404, detail="No form responses found")
                ...
                for idx, response in enumerate(form_responses):
                    ...
                    display_response = user_response_labels if is_answered and user_response_labels else "None"
